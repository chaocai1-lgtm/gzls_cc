...
既往口腔诊疗史：5年前曾在某诊所洁牙1次，之后未再进行管理维护。否认正畸治疗史。否认颌面部外伤史。""",
            "symptoms": ["牙龈红肿", "探诊出血", "管理袋形成4-6mm", "牙槽骨水平吸收", "口腔异味"],
            "diagnosis": "慢性管理炎（III期B级）",
            "difficulty": "简单",
...
【个人史】吸烟20年，每日10-15支，多次尝试戒烟未成功；偶尔社交饮酒，量不多。睡眠、饮食一般。工作压力中等。""",
            ...
            "auxiliary_examination": """【影像学检查】全口曲面体层片示：全口牙槽骨呈水平型吸收，骨吸收量约为根长的1/3-1/2；下颌第一磨牙根分叉区可见低密度影像，提示I度根分叉病变；硬骨板部分不连续，管理膜间隙增宽；未见明显根尖周病变及埋伏牙。
【实验室检查】（如有）血常规、凝血功能均正常。""",
            "treatment_plan": [
                "【基础治疗阶段】口腔卫生宣教，教授改良Bass刷牙法，每日2次，每次3分钟；推荐使用牙线或牙间隙刷清洁邻面。全口龈上洁治术，超声波洁牙机配合手工洁治器彻底去除龈上牙石及菌斑。分区龈下刮治及根面平整术（SRP），建议分2-4次完成全口治疗，局部麻醉下进行。深管理袋局部药物治疗，盐酸米诺环素软膏（派丽奥）缓释剂袋内给药。",
                "【再评估阶段】基础治疗完成4-6周后复诊，重新进行全口管理检查，记录探诊深度、附着水平、出血指数等，评估治疗效果。若残留探诊深度>5mm、骨内袋或根分叉病变未改善者，考虑管理手术治疗。",
                "【维护治疗阶段】建立终身管理支持治疗计划，每3个月复诊一次进行SPT，包括菌斑控制评估、专业清洁及强化宣教。强调戒烟的必要性，吸烟严重影响管理治疗效果及长期预后。监测血压控制情况，与心内科保持沟通。"
            ],
            "treatment_notes": "治疗注意事项：①高血压患者每次就诊前测量血压，血压>180/110mmHg时暂缓操作；②局麻药选择肾上腺素浓度不超过1:100000；③吸烟者应书面告知吸烟对管理治疗的不良影响；④预约复诊时间充足，避免患者等候时间过长导致焦虑。",
            "key_points": [
                "⚠️ 高血压患者注意事项：治疗前测量血压，控制在160/100mmHg以下方可操作，避免使用高浓度肾上腺素",
                "📋 吸烟与管理炎：吸烟是管理炎的重要危险因素，显著降低治疗效果，需强调戒烟",
                "🔄 长期随访：慢性管理炎需要终身维护治疗，复查间隔不超过3个月",
            ...
            "diagnosis_analysis": {
                ...
                "differential": {
                    "title": "鉴别诊断",
                    "items": [
                        "与侵袭性管理炎鉴别：本例发病年龄45岁，病程进展缓慢，破坏程度与菌斑量相符，临床附着丧失与年龄比值在正常范围，符合慢性管理炎特点",
                ...
                "staging": {
                    ...
                    "content": """【分期诊断】III期（严重管理炎）
依据：①附着丧失：最大附着丧失3-4mm；②影像学表现：骨吸收延伸至根中1/3-根尖1/3；③复杂性因素：存在I度根分叉病变，需纳入复杂治疗考量；④失牙：因管理炎失牙0颗。符合III期诊断标准。

【分级诊断】B级（中度进展）
依据：①直接证据：无5年以上的影像学资料用于纵向对比；②间接证据：骨丧失(mm)/年龄(岁)比值=4/45≈0.09，提示A级，但存在吸烟危险因素（10支/日属中重度吸烟）；③风险因素修正：吸烟使分级由A升至B级。最终诊断为III期B级慢性管理炎。"""
                }
            }
        },
        {
...
患者初中时（约14岁）曾因"牙龈出血"在当地诊所洁牙2次，医生曾说"管理有问题"，建议定期检查，但之后未再复诊。近2年感觉多颗后牙咬物略感无力，咀嚼效率下降，但因无疼痛未予重视。

月经生育史：月经规律，14岁初潮，周期28-30天，经量中等，无痛经。未婚未育。""",
            "symptoms": ["前牙扇形移位", "深管理袋>7mm", "快速骨吸收", "探诊出血", "牙齿松动"],
            "diagnosis": "侵袭性管理炎（IV期C级，广泛型）",
            "difficulty": "困难",
...
【实验室检查】血常规正常，排除血液系统疾病；空腹血糖5.2mmol/L，正常。建议完善免疫功能及遗传易感性相关检测。""",
            "treatment_plan": [
                "【急症处理与全身辅助治疗】松动前牙暂时性固定，光固化树脂夹板固定11-21牙稳定咬合功能。全身抗生素辅助治疗：因青霉素过敏，选用阿奇霉素500mg首剂，后250mg/日×4天，联合甲硝唑400mg每日3次共7天，针对侵袭性管理炎特征性致病菌（伴放线放线杆菌Aa）。",
                "【系统基础治疗】全口龈下刮治及根面平整术，分4次完成，局部麻醉下操作，重点处理深管理袋区域。深袋辅助药物治疗，盐酸米诺环素软膏局部缓释给药。强化口腔卫生指导，强调牙间隙清洁，推荐使用牙间隙刷。",
                "【手术治疗阶段】基础治疗后6-8周再评估，对残留深袋、骨下袋行管理翻瓣术，条件适合者考虑引导组织再生术（GTR）或植骨术，争取部分骨再生。16、26、36、46牙根分叉病变行隧道成形术或截根术评估。",
                "【长期维护与监测】建立严密随访计划，每2-3个月复查一次，周期短于慢性管理炎患者。考虑建议患者直系亲属进行管理筛查（遗传易感性）。可建议完善基因检测和免疫功能评估，用于预后判断。"
            ],
            "treatment_notes": "治疗注意事项：①青霉素过敏，严禁使用阿莫西林，选择大环内酯类替代；②年轻女性患者需关注心理状态，前牙美观问题可能造成心理负担，必要时转诊心理咨询；③家族史阳性，建议家族成员进行管理筛查；④抗生素使用期间避免饮酒。",
            "key_points": [
                "🧬 家族史高度阳性：母系家族成员有早期失牙史，高度提示遗传易感性，是诊断侵袭性管理炎的重要线索",
                "⚠️ 年轻患者严重破坏：28岁即出现严重骨吸收和牙齿松动，与年龄严重不符，需高度警惕侵袭性管理炎",
                "💊 抗生素选择：青霉素过敏患者不能使用阿莫西林，大环内酯类（阿奇霉素）是有效替代",
                "🔬 菌斑与破坏不成比例：口腔卫生状况尚可但组织破坏严重，是侵袭性管理炎的典型特征",
                "📅 密切随访：侵袭性管理炎复查间隔应为2-3个月，需终身严密监测"
            ],
            "diagnosis_analysis": {
                "clinical_exam": {
                    "title": "临床检查发现",
                    "items": [
                        ...
                        "深管理袋：第一磨牙及切牙区探诊深度达8-10mm，远超一般慢性管理炎",
                ...
                "radiographic": {
                    "title": "X线片分析",
                    "items": [
                        "第一磨牙呈典型'弧形'或'壶底状'垂直骨吸收，是侵袭性管理炎特征性表现",
                ...
                "differential": {
                    "title": "鉴别诊断",
                    "items": [
                        "与慢性管理炎鉴别：本例发病年龄轻（28岁），进展迅速，破坏严重程度与菌斑量不成比例，分布呈门牙-磨牙型特征，家族史阳性，均符合侵袭性管理炎而非慢性管理炎",
                        "排除血液系统疾病：需完善血常规检查排除白血病、再生障碍性贫血等导致的管理组织破坏，本例血常规正常",
                        "排除糖尿病：需排除未诊断的糖尿病导致的严重管理破坏，本例空腹血糖正常",
                        "家族史支持：母亲早期多牙脱落、外祖母也有类似病史，高度支持遗传易感性相关的侵袭性管理炎诊断"
                    ]
                },
                "staging": {
                    "title": "分期分级依据（2018年新分类）",
                    "content": """【分期诊断】IV期（晚期管理炎伴咬合功能障碍）
依据：①附着丧失≥5mm；②骨吸收延伸至根中1/3至根尖1/3；③存在继发表现：前牙扇形移位、咬合关系改变、咀嚼功能明显受损；④根分叉病变达II-III度；⑤符合IV期的复杂治疗需求。

【分级诊断】C级（快速进展）
依据：①直接证据：病史提示1-2年内有明显进展，初中时即有管理问题；②间接证据：年轻患者（28岁）即出现与其年龄严重不符的广泛破坏，骨丧失/年龄比值远超1.0；③分布特征：符合原"侵袭性管理炎"的门牙-磨牙型分布特点；④危险因素：无吸烟等传统危险因素，但有明确家族史。

【诊断转换说明】按2018年新分类，原"侵袭性管理炎"已纳入管理炎的分期分级系统，诊断为IV期C级管理炎（原侵袭性管理炎，广泛型）。"""
                }
            }
        },
        {
...
血糖情况：患者近期在社区医院体检发现血糖偏高，空腹血糖8.5-9.2mmol/L，餐后2小时血糖12-14mmol/L，目前服药调整中。""",
            "symptoms": ["牙齿叩痛(+)", "牙龈窦道", "深管理袋达根尖", "根尖暗影", "牙齿松动"],
            "diagnosis": "管理-牙髓联合病变（真性联合病变）",
            "difficulty": "困难",
...
【个人史】不吸烟，偶尔应酬饮酒。近1年工作压力较大，饮食作息不规律，体重较前增加约5kg。睡眠质量一般。""",
            "clinical_manifestation": """口腔检查：46牙冠可见大面积银汞合金充填体，充填体边缘密合性尚可；叩诊（++）不适明显，冷热测无反应，牙髓电活力测试无反应（提示牙髓坏死）；颊侧龈粘膜近根尖处可见一窦道口，轻压有少量脓性分泌物溢出，窦道探针探查可通向根尖区；46牙颊侧探诊，管理袋从冠方延伸至根尖部，最深达12mm，形成连续性通道；牙齿松动II度；邻牙未见明显异常。""",
            "auxiliary_examination": """【影像学检查】46牙根尖片及CBCT示：46牙远中根根尖区可见椭圆形低密度透射影，直径约5mm，边界尚清；近中骨吸收从冠方延伸至根尖区域，形成典型"J"形连续透射影像，管理-根尖病变相互交通；根分叉区亦可见透射影，提示II度根分叉病变；管理膜间隙明显增宽。
【实验室检查】血常规大致正常；空腹血糖8.8mmol/L，糖化血红蛋白（HbA1c）8.2%，提示近3个月血糖控制欠佳。""",
            "treatment_plan": [
                ...
                "【管理状态再评估】根管治疗完成后2-3个月复查，评估管理组织愈合情况，重新探诊记录管理袋深度变化。若管理袋持续较深（>5mm），待血糖控制稳定后（空腹<7.0mmol/L、HbA1c<7%）考虑行管理翻瓣术联合植骨术。根分叉病变的处理：评估是否行隧道成形术或截根术。",
                "【修复与长期维护】管理稳定后行全冠修复保护患牙，选择高强度材料。每3个月复查管理及根尖状态，持续监测。同步监测血糖控制情况，强调代谢控制对管理愈合的重要性。与内分泌科保持沟通协作。"
            ],
            ...
            "key_points": [
                "🔍 鉴别原发病灶：真性联合病变需判断病变来源，本例牙髓坏死（活力测试阴性）合并管理破坏（深袋达根尖），两个途径同时存在并相交通",
                "🩸 糖尿病影响治疗：高血糖状态影响愈合和感染控制能力，需与内分泌科协同管理，控制血糖是治疗成功的前提",
                "👥 多学科协作：本病例涉及牙体牙髓科、管理科、修复科及内分泌科，需多专业协作制定治疗方案",
                "📅 序贯治疗原则：先控制急性感染（开髓引流、抗感染），再行根管治疗，最后评估是否需要管理手术",
                "⏰ 预后评估：真性联合病变因同时存在两种病变来源，预后较单纯牙髓病或管理病差，需充分知情"
            ],
            "diagnosis_analysis": {
                "clinical_exam": {
                    "title": "临床检查发现",
                    "items": [
                        ...
                        "管理探诊：颊侧管理袋从冠方延伸至根尖区域，最深达12mm，形成连续通道，管理与根尖病变相交通",
                        "牙齿松动：II度松动，提示管理支持组织大量丧失",
                        "根分叉探查：可探及根分叉区病变"
                    ]
                },
                "radiographic": {
                    ...
                    "items": [
                        ...
                        "近中骨吸收从冠方沿管理膜间隙延伸至根尖区，形成典型J形透射影",
                        "管理-根尖病变通过共同通道连通，符合真性联合病变影像学特征",
                        "根分叉区透射影像提示II度根分叉病变",
                        "管理膜间隙弥漫性增宽"
                    ]
                },
                "differential": {
                    "title": "鉴别诊断",
                    "items": [
                        "原发性牙髓病变继发管理病变：牙髓坏死在先（深龋史），根尖感染后沿根面向冠方蔓延，形成逆行性管理袋；牙髓活力测试阴性、根尖病变支持此途径",
                        "原发性管理病变继发牙髓病变：管理袋进展至根尖或侧支根管，感染逆行进入髓腔导致牙髓坏死；深管理袋支持此途径",
                        "真性联合病变（最终诊断）：本例既有明确的牙髓源性（深龋、活力丧失、根尖病变），又有管理源性（深管理袋从冠方延伸），两者相互交通形成联合病变",
...
本例符合真性联合病变诊断：①明确的牙髓坏死证据（活力测试阴性、根尖病变）提示存在牙髓源性感染；②深管理袋从冠方延伸至根尖、根分叉病变提示存在原发性管理破坏；③两者通过根尖区或侧支根管相交通，形成典型"J"形影像。

【预后评估】中等偏差
预后影响因素：①糖尿病控制欠佳影响愈合；②存在根分叉病变增加治疗难度；③真性联合病变预后较单纯病变差；④需评估患牙在全口中的战略价值决定是否保留。若经规范治疗（血糖控制+根管治疗+必要的管理手术）病变仍无法控制，需考虑拔除。"""
                }
            }
        },
        {
...
口腔卫生情况：既往每日刷牙1次，约2分钟。牙龈增大后因刷牙容易出血而不敢用力，刷牙时间缩短，清洁效果更差。""",
            "symptoms": ["牙龈弥漫性增生", "质地较韧", "覆盖牙面1/3-1/2", "菌斑堆积明显", "假性管理袋"],
...
【个人史】不吸烟不饮酒。已绝经5年，未行激素替代治疗。睡眠饮食一般。退休后生活规律，无明显精神压力。""",
            "clinical_manifestation": """口腔检查：全口牙龈弥漫性增生，上下颌前牙区及磨牙区尤为明显；龈乳头圆钝肥大，相邻牙的龈乳头融合，覆盖牙冠约1/3-1/2；增生牙龈颜色淡粉红，质地较韧实，表面可见浅分叶；龈缘及牙间隙处菌斑堆积明显；探诊深度4-6mm，但主要为假性管理袋（龈缘向冠方增生所致）；探诊出血率约50%；牙齿无明显松动。""",
            "auxiliary_examination": """【影像学检查】全口曲面体层片示：全口牙槽骨未见明显吸收，牙槽嵴顶位于釉牙骨质界下方1-2mm正常范围；硬骨板连续，管理膜间隙正常；无根尖周病变征象。影像学检查提示为单纯软组织增生，无骨组织破坏（真性管理袋）。
【实验室检查】血常规正常，排除白血病等血液系统疾病导致的牙龈肿大。空腹血糖正常。""",
            "treatment_plan": [
                ...
                "【手术治疗（如有需要）】若换药后2-3个月增生未消退或消退不完全，需行牙龈切除术。手术方式：传统手术刀或电刀切除增生牙龈，恢复正常牙龈外形；条件允许可使用激光辅助，减少出血。术后管理塞治剂保护创面约1周，术后1周拆除观察愈合。",
            ...
            "diagnosis_analysis": {
                "clinical_exam": {
                    ...
                    "items": [
                        ...
                        "探诊检查：探诊深度4-6mm，但为假性管理袋（龈缘向冠方增生所致，并非附着丧失）",
                        "牙齿情况：牙齿无明显松动，咬合关系正常"
                    ]
                },
                "radiographic": {
                    ...
                    "items": [
                        ...
                        "硬骨板连续完整，管理膜间隙正常，无骨下袋形成",
                        "影像学表现与临床假性管理袋相符——单纯软组织增生，非真性管理破坏",
                        "无根尖周病变及其他牙源性病变",
                        "影像学检查有助于鉴别药物性牙龈增生与伴骨吸收的管理炎"
                    ]
                },
                "differential": {
                    "title": "鉴别诊断",
                    "items": [
                        ...
                        "与慢性管理炎鉴别：慢性管理炎有真性管理袋（附着丧失）和牙槽骨吸收；本例为假性管理袋，X线无骨吸收，为单纯软组织增生",
...
【实验室检查】血常规：白细胞计数轻度升高（11.2×10^9/L），中性粒细胞比例偏高；血红蛋白、血小板正常。C反应蛋白轻度升高。建议完善HIV抗体筛查（告知患者后）。""",
            ...
            "key_points": [
                "🚨 急性发病特征：发病急骤，进展迅速，疼痛剧烈，是管理病中少数引起明显疼痛的疾病",
            ...
            "diagnosis_analysis": {
                "clinical_exam": {
                    ...
                    "items": [
                        ...
                        "剧烈疼痛：触碰牙龈即引起剧痛，患者常因疼痛拒绝口腔检查，是NUG区别于其他管理病的重要特点",
                ...
                "differential": {
                    ...
                    "items": [
                        ...
                        "与HIV相关管理病鉴别：NUG可为HIV感染的首发口腔表现，尤其反复发作者应高度警惕；建议HIV筛查",
                        "与坏死性溃疡性管理炎（NUP）鉴别：NUG限于牙龈，NUP进展至管理组织伴骨吸收；本例尚无骨吸收证据，诊断为NUG"
                    ]
                },
                "staging": {
                    "title": "病因分析与预后评估",
...
• 进展风险：若不及时治疗可进展为坏死性溃疡性管理炎（NUP），造成骨组织破坏。"""
                }
            }
        }
    ]
